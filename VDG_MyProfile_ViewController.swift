//
//  VDG_MyProfile_ViewController.swift
//  VeriDocG
//
...
class VDG_MyProfile_ViewController: UIViewController, MFMailComposeViewControllerDelegate, UITextFieldDelegate, UITextViewDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        //  vw_Bk1.layer.cornerRadius = 8
        //  vw_Bk1.clipsToBounds = true
        ...
        if Connectivity.isConnectedToInternet {
            ...
            let str_Profile = UserDefaults.standard.string(forKey: "profile")
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        //        imageView  = UIImageView(frame:CGRect(x:self.img_Profile.frame.origin.x + self.img_Profile.frame.width - 13, y:self.img_Profile.frame.origin.y + self.img_Profile.frame.height - 13, width:26, height:26));
        imageView.image = UIImage(named:"icn_white_add_profile")
    ...
    @IBAction func btn_Save(_ sender: UIButton)  {
        ...
        if Connectivity.isConnectedToInternet {
            ...
            // let str_OldPassword = retrievedPassword!["customerguid"] as! String
    ...
    func updateHistory(str_FirsrName: String, str_LastName: String) {
        ...
        var data = Data()
        data = UIImageJPEGRepresentation(img_Profile.image!, 0.8)!
        ...
        let uploadPict = imageRef.putData(data, metadata: nil){  (metadata, error) in
            ...
            imageRef.downloadURL { (url, error) in
                ...
                if error == nil {
                    ...
                    let userID = userDetail!["customerguid"] as! String
                    dic_Histrory[userID] = urlString as AnyObject
                    ...
                    //  lbl_LastName.text = str_LastName
