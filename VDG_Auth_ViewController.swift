//
//  VDG_Auth_ViewController.swift
//  VeriDocG
//
//  Created by Bhavdip Patel on 23/07/18.
...
class VDG_Auth_ViewController: UIViewController, UITextFieldDelegate {
    ...
    override func viewDidAppear(_ animated: Bool) {
      ...
      //  btn_LogIn.applyGradient(colours: [color3,color2,color1])
...
//        
//        let secondViewController = self.storyboard?.instantiateViewController(withIdentifier: "VDG_ForgotPassword_ViewController") as! VDG_ForgotPassword_ViewController
                ...
                if bool == true {
                    ...
                    if bool == true {
                        ...
                        if returnCode == 1{
                           ...
                           // UserDefaults.standard.setValue(dictionary, forKey:"logininfo")
                           // UserDefaults.standard.synchronize()
