//
//  VDG_SignUp_ViewController.swift
//  VeriDocG
//
//  Created by Bhavdip Patel on 04/07/18.
...
class VDG_SignUp_ViewController: UIViewController, UITextFieldDelegate {
    ...
    override func viewDidAppear(_ animated: Bool) {
      //  btn_Submit.layer.cornerRadius = 8
        //btn_Submit.applyGradientButton()
    }
...
//        txt_Email.text = "test@ios.com"
//        txt_FirstName.text = "iOS FirstName"
//        txt_LastName.text = "iOS LastName"
//        txt_Password.text = "admin"
//        txt_ConPassword.text = "admin"
        ...
        phoneNumberTextField.flagSize = CGSize(width: 36, height: 36)
        phoneNumberTextField.flagButtonEdgeInsets = UIEdgeInsets(top: 5, left: 5, bottom: 5, right: 5)
       
        phoneNumberTextField.hasPhoneNumberExample = true
//        phoneNumberTextField.layer.borderColor = Constant.GlobalConstants.kColor_Theme.cgColor
//        phoneNumberTextField.layer.borderWidth = 1.0
        
      //  phoneNumberTextField.flagButton.setTitleColor(.white, for: .normal)
        
        txt_FirstName.attributedPlaceholder = NSAttributedString(string: "First Name",
                                                             attributes: [NSAttributedString.Key.foregroundColor: UIColor.init(red: 138/255, green: 171/255, blue: 145/255, alpha: 1.0)])
        
        txt_LastName.attributedPlaceholder = NSAttributedString(string: "Last Name",
                                                                attributes: [NSAttributedString.Key.foregroundColor: UIColor.init(red: 138/255, green: 171/255, blue: 145/255, alpha: 1.0)])
        
        txt_Email.attributedPlaceholder = NSAttributedString(string: "Email Address",
                                                                attributes: [NSAttributedString.Key.foregroundColor: UIColor.init(red: 138/255, green: 171/255, blue: 145/255, alpha: 1.0)])
        
        phoneNumberTextField.attributedPlaceholder = NSAttributedString(string: "Mobile Number",
                                                             attributes: [NSAttributedString.Key.foregroundColor: UIColor.init(red: 138/255, green: 171/255, blue: 145/255, alpha: 1.0)])
        
        txt_Password.attributedPlaceholder = NSAttributedString(string: "Password",
                                                                    attributes: [NSAttributedString.Key.foregroundColor: UIColor.init(red: 138/255, green: 171/255, blue: 145/255, alpha: 1.0)])
        
        txt_ConPassword.attributedPlaceholder = NSAttributedString(string: "Confirm Password",
                                                                attributes: [NSAttributedString.Key.foregroundColor: UIColor.init(red: 138/255, green: 171/255, blue: 145/255, alpha: 1.0)])
    }
    ...
    @IBAction func btn_Submit(_ sender: UIButton) {
        ...
        if (txt_FirstName.text?.removingWhitespaces(txt_FirstName.text).isEmpty)!{
           ...
           //txt_FirstName.setValidationMsg("Please enter firstname")
            ...
            let dictParams: [String: AnyObject] = ["firstname" : txt_FirstName.text as AnyObject ,
                                                   "email" : txt_Email.text as AnyObject , // Always use optional values carefully!
